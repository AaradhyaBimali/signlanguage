    ...
    for action in actions:
        ...
        for sequence in range(no_sequences):
            ...
            for frame_num in range(sequence_length):
                frame=cv2.imread(f'image/{action}/{frame_num + sequence * sequence_length}.png') #read image from collected data
                ...
                draw_landmarks(image, results) #draw hand landmarks on image
